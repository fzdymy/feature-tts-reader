...
final class AudioPlaybackController: NSObject, ObservableObject, @unchecked Sendable {
    ...
    func playFilesAndWait(_ urls: [URL]) async {
        let items = urls.map { TTSQueueItem(segment: ScriptSegment(id: UUID(), characterName: "", voice: "", rate: 0, pitch: 0, style: "", text: ""), audioURL: $0, chapterTitle: "", bookTitle: "", bookID: "", chapterIndex: 0, segmentIndex: 0, totalSegments: urls.count, paragraphIndex: nil, sentenceIndex: nil, anchor: nil) }
